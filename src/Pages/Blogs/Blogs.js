            ...
            <section className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3  drop-shadow-4xl gap-10 mx-10 py-10'>
                <div className="card w-96 bg-base-100 shadow-xl">
                    <div className="card-body">
                        <h2 className="card-title"> How will you improve the performance of react Application?</h2>
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <div className="card-body">
                        <h2 className="card-title">What are different ways to manage a state in a react application?</h2>
                ...
                <div className="card w-96 bg-base-100 shadow-xl ">
                    <div className="card-body">
                        <h2 className="card-title">Why you dont state directly in React ?For example, If You have const [products,setProducts]=useState.
